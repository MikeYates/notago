...
class NotificationRecord extends FirestoreRecord {
  ...
  // "invoiceDocument" field.
  DocumentReference? _invoiceDocument;
  DocumentReference? get invoiceDocument => _invoiceDocument;
  bool hasInvoiceDocument() => _invoiceDocument != null;
  ...
  void _initializeFields() {
    ...
    _invoiceDocument = snapshotData['invoiceDocument'] as DocumentReference?;
...
Map<String, dynamic> createNotificationRecordData({
  ...
  DocumentReference? invoiceDocument,
  bool? isRead,
}) {
...
class NotificationRecordDocumentEquality
  ...
  bool equals(NotificationRecord? e1, NotificationRecord? e2) {
    return e1?.createdDate == e2?.createdDate &&
        ...
        e1?.invoiceDocument == e2?.invoiceDocument &&
        e1?.isRead == e2?.isRead;
  }

  @override
  int hash(NotificationRecord? e) => const ListEquality()
      .hash([e?.createdDate, e?.createdBy, e?.invoiceDocument, e?.isRead]);
