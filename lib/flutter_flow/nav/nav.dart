...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const DashboardWidget() : const HomePageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'createInvoice',
          path: '/createInvoice',
          builder: (context, params) => const CreateInvoiceWidget(),
        ),
        FFRoute(
          name: 'dashboard',
          path: '/dashboard',
        ...
        FFRoute(
          ...
          path: '/invoices',
          requireAuth: true,
          builder: (context, params) => const InvoicesWidget(),
        ),
        FFRoute(
          name: 'invoiceDetails',
          path: '/invoiceDetails',
