  ...
  Widget build(BuildContext context) {
    return StreamBuilder<InvoicesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final invoiceDetailsInvoicesRecord = snapshot.data!;
                            ...
                            children: [
                              Text(
                                'Invoice #${valueOrDefault<String>(
                                  invoiceDetailsInvoicesRecord.invoiceNumber,
                                  '0',
                                )}',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Builder(
                              builder: (context) {
                                final invoiceItems =
                                    invoiceDetailsInvoicesRecord.invoiceItems
                                        .toList();
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (context, invoiceItemsIndex) {
                                    final invoiceItemsItem =
                                        invoiceItems[invoiceItemsIndex];
                                    return StreamBuilder<InvoiceItemsRecord>(
                                      stream: InvoiceItemsRecord.getDocument(
                                          invoiceItemsItem),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        if (!snapshot.hasData) {
